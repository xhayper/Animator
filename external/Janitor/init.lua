...
-- Made complatible with Animator by xhayper

local RbxScriptConnection = AnimatorUtility.httpRequire(AnimatorUtility.formatUrl("external/Janitor/RbxScriptConnection.lua"), true)
local Symbol = AnimatorUtility.httpRequire(AnimatorUtility.formatUrl("external/Janitor/Symbol.lua"), true)
